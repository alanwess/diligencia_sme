      ...
      <div class="row">
        <div class="col-md-8 col-lg-9">
          ...
          ?>
            ...
            <article class="post">
              ...
              <header>
                ...
                <time datetime="2016-04-04 20:00"><?= get_the_date(); ?>
                  <?php  
                        ...
                        if ( ! empty( $categories ) ) {
                            foreach( $categories as $category ) {
                                $output .= '<a href="' . esc_html(get_category_link( $category->term_id )) . '" alt="' . esc_attr( sprintf( __( 'Veja todos os posts em %s', 'textdomain' ), $category->name ) ) . '">' . esc_html( $category->name ) . '</a>' . $separator;
                            }
          ...
          <?php
              ...
              echo "<h4>Não foi encontrado nenhum post para ser exibido nesse momento.</h4>";
            endif;
          ?>
                  ...
                  <div class="content">
                    ...
                    <time datetime="2016-04-04 20:00">
                      ...
                      <?php  
                        ...
                        if ( ! empty( $categories ) ) {
                            foreach( $categories as $category ) {
                                $output .= 'Seção <a href="'  . esc_url( get_category_link( $category->term_id ) ) . '" alt="' . esc_attr( sprintf( __( ' %s', 'textdomain' ), $category->name ) ) . '">' . esc_html( $category->name ) . '</a>' . $separator;
                            }
