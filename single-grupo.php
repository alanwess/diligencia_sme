    ...
    <main class="container blog-page">
      ...
      <div class="row"> 
          ...
          <article class="post">
            ...
            ?>
              <div class="blog-content">
                ...
                <br>
                <h4>Acesse o link do grupo no facebook: </h2>
                <a href="<?= $meta_data['grupo_id'][0]; ?>" class="btn btn-info"><i class="fa fa-facebook"></i> Acessar grupo!</a>
                <hr>
              </div>
            ...
            ?>
            <i><small><font size="2px">Navegar entre os grupos:</font></small></i>
            <nav>
              <ul class="pager">
        ...
        <div class="col-md-4 col-lg-3">
          ...
          <div class="widget">
            <h6 class="widget-title">Vagas populares</h6>
            <ul class="widget-body item-blocks-connected">
              <?php
              ...
              ?>
                  <a class="item-block" href="<?= the_permalink(); ?>">
                    <header>
                      <div class="hgroup">
                        <h6><?php echo str_replace("Trampo: ", "", get_the_title()); ?></h6>
                        <h5>
                          <?php 
                            if($search_meta_data['origemvaga_id'][0] == '')
                              echo "Via careernjob.com"; 
                            else
